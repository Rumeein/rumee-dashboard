...
Current-state architecture for the Materials/Stock/BOM/Job Workers subsystem (built incrementally 2026-07-11 through 2026-08-03 — full session-by-session history is in dashboard memory `active.md`, items #79-#108; this section is the durable "how it works now," not the history). QC's own two-stage Inspect/Repair mechanics are documented in §26 above (Purchases module) since QC events live on the Purchase doc — this section covers what happens to STOCK as a result.
